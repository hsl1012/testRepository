...
public class MessageVerifyUtils {
    ...
    static final String accessKeyId = "LTAI4G5pwkXmmtj9Be3FdXBj";           // TODO 改这里
    static final String accessKeySecret = "yKHCaIGO4lnl4YJxaa0GE1K95FsAvQ"; // TODO 改这里
    ...
    public static SendSmsResponse sendSms(String userPhone, String userCode) throws ClientException {
        ...
        // 必填:短信模板-可在短信控制台中找到
        request.setTemplateCode("SMS_196643041");  // TODO 改这里
